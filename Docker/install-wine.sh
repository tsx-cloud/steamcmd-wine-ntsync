...
apt-get install -y fonts-freefont-ttf fonts-liberation fonts-noto-core fonts-noto-mono fonts-texgyre fonts-urw-base35 gcc-15-base iso-codes libacl1 libaom3
...
apt-get install -y libffi8 libflac14 libfontconfig1 libfontenc1 libfreetype6 libfribidi0 libgcc-s1 libgd3 libglib2.0-0t64 libgmp10
...
apt-get install -y libxdmcp6 libxext6 libxkbcommon0 libxkbregistry0 libxml2 libxpm4 libz-mingw-w64 libzstd1 login.defs lsb-base
apt-get install -y ocl-icd-libopencl1 openssl-provider-legacy passwd sysvinit-utils x11-common xfonts-encodings xfonts-utils xkb-data zlib1g
